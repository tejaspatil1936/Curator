...
def main():
    ...
    print("Re-generating narrative for #803 with planted alert...")
    narr = generate_incident_narrative(803, session=db)
    ...
    print("Mapping techniques for #803...")
    map_res = map_incident_techniques(803, session=db)
